...
class UnityEnv(gym.Env):
    ...
    def __init__(self, environment_filename: str, worker_id=0, use_visual=False, use_both=False, uint8_visual=False, multiagent=False, flatten_branched=False):
        """
    ...
    def _single_step(self, info):
        if self.use_visual:
            info.visual_observations = np.array(info.visual_observations)  # added
